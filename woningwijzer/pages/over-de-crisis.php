        ...
        <div class="bg-white dark:bg-gray-800 dark:text-gray-200 rounded-xl border border-gray-100 dark:border-gray-700 p-6">
            ...
            <ul class="space-y-4 text-sm text-gedempt">
                <li class="flex gap-3">
                    ...
                    <span><strong class="text-ink dark:text-gray-100">Te weinig bouwen</strong> — Sinds 2010 zijn er structureel te weinig woningen gebouwd. Doel was 100.000 per jaar, maar de realiteit lag vaak rond de 60.000–70.000.</span>
                </li>
                <li class="flex gap-3">
                    <span class="font-bold text-oranje shrink-0">2.</span>
                    <span><strong class="text-ink dark:text-gray-100">Groeiende bevolking</strong> — Meer mensen, kleinere huishoudens, immigratie: de vraag naar woningen stijgt sneller dan het aanbod.</span>
                </li>
                <li class="flex gap-3">
                    <span class="font-bold text-oranje shrink-0">3.</span>
                    <span><strong class="text-ink dark:text-gray-100">Stikstofcrisis</strong> — Door stikstofregels komen bouwprojecten stil te liggen. Vergunningen worden vertraagd of ingetrokken.</span>
                </li>
                <li class="flex gap-3">
                    <span class="font-bold text-oranje shrink-0">4.</span>
                    <span><strong class="text-ink dark:text-gray-100">Beleggers en buy-to-let</strong> — Beleggers kochten grote aantallen woningen op, waardoor starters en middeninkomens worden buitengesloten.</span>
                </li>
                <li class="flex gap-3">
                    <span class="font-bold text-oranje shrink-0">5.</span>
                    <span><strong class="text-ink dark:text-gray-100">Liberalisatie huurmarkt</strong> — Sinds 2015 is de sociale huursector fors gekrompen. Veel woningen zijn overgeheveld naar de dure vrije sector.</span>
                </li>
            </ul>
        </div>
    ...
    <div class="bg-orange-50 border border-orange-200 rounded-xl p-6 mb-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
            <div class="bg-white dark:bg-gray-800 dark:text-gray-200 rounded-xl p-4">
                <p class="font-bold text-ink dark:text-gray-100 mb-1">🏗️ Versneld bouwen</p>
            ...
            <div class="bg-white dark:bg-gray-800 dark:text-gray-200 rounded-xl p-4">
                <p class="font-bold text-ink dark:text-gray-100 mb-1">🛑 Beleggers weren</p>
            ...
            <div class="bg-white dark:bg-gray-800 dark:text-gray-200 rounded-xl p-4">
                <p class="font-bold text-ink dark:text-gray-100 mb-1">🧑‍⚖️ Huurders beschermen</p>
